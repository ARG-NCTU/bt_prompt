...
def custom_write_tree(response, output_dir, count):
	...
	if len(sections) == 2:
		...
		tree_1_file = os.path.join(output_dir, f"searching_subtree_{count}.tree")
		...
		tree_2_file = os.path.join(output_dir, f"final_tree_{count}.tree")
...
if __name__ == "__main__":
	...
	parser.add_argument(
		"--prompt_file",
		type=str,
		default="search_prompt_template.txt",
